...
Blockly.JavaScript['mover'] = function(block) {
 ...
 var nosteps = parseFloat(text_nosteps);//si la opcion fue forward, llama la funcion forward
...
Blockly.JavaScript['mover_pintando'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = '';
  var pasos = parseFloat(text_pasos);
...
Blockly.JavaScript['girar'] = function(block) {
  ...
  var code = '';
  var angulo=parseFloat(angle_grades);
  //alert(angulo);
